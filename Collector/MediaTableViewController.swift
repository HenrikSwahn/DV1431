...
class MediaTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let mov1 = Movie(title: "I am Legend", released: 2007, runtime: Runtime(hours: 1, minutes: 40, seconds: 40), age: 18, mainActors: ["Balbla", "Alalal"], director: "A director")
        
        let mus1 = Music(title: "A album", released: 2007, artist: "Cool")
            print(mov1.toDictionary())
    }
